...
def Story1(window):
    def final(tl: Toplevel, friend_name, sports, City, playername, drinkname, snacks):
        ...
        text = f'''
           One day me and my friend { friend_name} decided to play a {sports}   in {City}.
    ...
    NewScreen = Toplevel(window, bg='yellow')
...
Label(Screen, text='Choose a topic', ).place(x=150, y=20)
