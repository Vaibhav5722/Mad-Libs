...
def Story3(window):
    ...
    SubmitButton = Button(NewScreen, text="Submit", background="white", font=('Times', 12), command=lambda: final(NewScreen, Animal.get(), Place.get(), Action.get(), Emotion.get(),Food.get()))
    SubmitButton.place(x=150, y=270)
